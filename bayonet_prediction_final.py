...
def main():
    ...
    # bayonet_data_csv_file = "./real_data/train_test_data/train_data_1.csv"
    # bayonet_data = np.loadtxt(bayonet_data_csv_file, dtype="str", delimiter=",", skiprows=1, usecols=(1, 2))
    # 单车卡口数据的数据预处理
    """
    # 存在一些有问题的数据，筛选掉
    delete = []
    ...
    trajectory_list = []
    # test的路径
    train_bayonet_csv_file = "./real_data/train_test_data/train_data_1.csv"
    ...
    for i in range(len(train_bayonet_data)):
        ...
        if trajectory_list:
            if (train_bayonet_data[i - 1][1] == train_bayonet_data[i][1]):
                ...
                # time.sleep(5)
    #print(trajectory_list_list[:10000])
    # print("\n")
    #time.sleep(1000)
...
def produce_test_data():
    ...
    # test的路径
    test_bayonet_csv_file = "./real_data/train_test_data/test_data"
...
def produce_test_data():
    ...
    test_trajectory_list = []
    # test的路径
    test_bayonet_csv_file = "./real_data/train_test_data/test_data_1.csv"
