...
trajectory_list = []
# test的路径
train_bayonet_csv_file = "./real_data/train_test_data_2/train_data_3.csv"
...
# test的路径
test_bayonet_csv_file = "./real_data/train_test_data_2/test_data_3.csv"
